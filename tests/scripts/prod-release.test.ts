...
describe("production release script guards", () => {
  ...
  it("rejects archives that do not contain current user asset publishing features", () => {
    ...
    expect(script).toContain("miniapp/pages/guides/index.vue::syncCustomTabBarSelected(1)");
    ...
    expect(script).toContain("miniapp/pages/profile/index.vue::我的交换");
    expect(script).toContain("miniapp/pages/profile/index.vue::syncCustomTabBarSelected(2)");
    expect(script).toContain("api/src/modules/redeemCodes/redeemCodes.routes.ts::/api/redeem-codes");
    expect(script).toContain("admin/src/pages/RedeemCodeSettingsPage.tsx::兑换码|奖励说明|效期");
    expect(script).toContain("miniapp/utils/share.ts::buildGuidesShare");
    expect(script).toContain("miniapp/utils/share.ts::buildRedeemCodesShare");
    expect(script).toContain("miniapp/utils/share.ts::buildDragonBallSystemShare");
    expect(script).toContain("miniapp/utils/share.ts::buildDeepSeaBattleShare");
    expect(script).toContain("miniapp/utils/share.ts::buildDeepSeaBossShare");
    expect(script).toContain("miniapp/utils/share.ts::buildMaelstromShare");
    expect(script).toContain("miniapp/utils/share.ts::buildMaelstromBossShare");
    expect(script).toContain("miniapp/utils/share.ts::buildSkyTowerShare");
    expect(script).toContain("miniapp/utils/share.ts::buildHealthCalculatorShare");
    expect(script).toContain("miniapp/utils/share.ts::buildAdditionalCalculatorShare");
    expect(script).toContain("miniapp/utils/share.ts::buildCardUpgradeShare");
    expect(script).toContain("miniapp/utils/share.ts::buildSeasonChallengeShare");
    expect(script).toContain("miniapp/utils/share.ts::buildDungeonMaterialsShare");
    expect(script).toContain("miniapp/utils/share.ts::buildDungeonGuideShare");
    expect(script).toContain("shared/src/deepSeaBattle.ts::calculateDeepSeaBoss");
    expect(script).toContain("shared/src/maelstrom.ts::calculateMaelstromBoss");
    expect(script).toContain("shared/src/skyTower.ts::skyTowerFloorPages");
    expect(script).toContain("shared/src/skyTower.ts::parseSkyTowerConfigText");
    expect(script).toContain("shared/src/healthCalculator.ts::calculateHealth");
    expect(script).toContain("shared/src/additionalCalculator.ts::calculateAdditionalDamage");
    expect(script).toContain("shared/src/cardUpgrade.ts::calculateCardUpgrade");
    expect(script).toContain("shared/src/seasonChallenge.ts::calculateSeasonChallenge");
    expect(script).toContain("api/src/db/migrations/025_sky_tower_settings.sql::sky_tower_settings");
    expect(script).toContain("api/src/db/migrations/026_check_in_url_config.sql::check_in_url");
    expect(script).toContain("api/src/db/migrations/027_dungeon_image_urls.sql::dungeon_material_image_url");
    expect(script).toContain("api/src/db/migrations/027_dungeon_image_urls.sql::dungeon_guide_image_url");
    expect(script).toContain("api/src/db/migrations/028_system_config_value_text.sql::MODIFY config_value TEXT");
    expect(script).toContain("api/src/modules/admin/adminConfigs.routes.ts::/api/app-config");
    expect(script).toContain("api/src/modules/admin/adminConfigs.routes.ts::dungeonMaterialImageUrl");
    expect(script).toContain("api/src/modules/admin/adminConfigs.routes.ts::dungeonGuideImageUrls");
    expect(script).toContain("api/src/modules/skyTower/skyTower.routes.ts::/api/sky-tower");
    expect(script).toContain("api/src/modules/skyTower/skyTowerSettings.mysql.repository.ts::sky_tower_settings");
    expect(script).toContain("miniapp/pages/guides/index.vue::buildGuidesShare");
    expect(script).toContain("miniapp/pages/guides/index.vue::openDragonBallSystem");
    expect(script).toContain("miniapp/pages/guides/index.vue::openDeepSeaBattle");
    expect(script).toContain("miniapp/pages/guides/index.vue::openMaelstrom");
    expect(script).toContain("miniapp/pages/guides/index.vue::openSkyTower");
    expect(script).toContain("miniapp/pages/guides/index.vue::openDungeonMaterials");
    expect(script).toContain("miniapp/pages/guides/index.vue::openDungeonGuide");
    expect(script).toContain("miniapp/pages/guides/index.vue::hasActivityEntries");
    expect(script).toContain("miniapp/pages/guides/index.vue::dungeonMaterialImageUrl");
    expect(script).toContain("miniapp/pages/guides/index.vue::hasDungeonGuideImages");
    expect(script).toContain("miniapp/pages/guides/index.vue::dungeonGuideImageUrls");
    expect(script).toContain("miniapp/pages/guides/index.vue::openCardUpgrade");
    expect(script).toContain("miniapp/pages/guides/index.vue::openSeasonChallenge");
    expect(script).toContain("miniapp/pages/guides/index.vue::openHealthCalculator");
    expect(script).toContain("miniapp/pages/guides/index.vue::openAdditionalCalculator");
    expect(script).toContain("miniapp/pages/guides/index.vue::openCheckIn");
    expect(script).toContain("miniapp/pages/guides/index.vue::uni.setClipboardData");
    expect(script).toContain("miniapp/pages/guides/index.vue::请在微信内打开");
    expect(script).not.toContain("miniapp/pages/guides/check-in-webview.vue::<web-view");
    expect(script).toContain("miniapp/pages/guides/redeem-codes.vue::buildRedeemCodesShare");
    expect(script).toContain("miniapp/pages/guides/redeem-codes.vue::uni.setClipboardData");
    expect(script).toContain("miniapp/pages/guides/dragon-ball-system.vue::龙珠获取方式");
    expect(script).toContain("miniapp/pages/guides/dragon-ball-system.vue::buildDragonBallSystemShare");
    expect(script).toContain("miniapp/pages/guides/deep-sea-battle.vue::deepSeaMapRows");
    expect(script).toContain("miniapp/pages/guides/deep-sea-boss.vue::calculateDeepSeaBoss");
    expect(script).toContain("miniapp/pages/guides/deep-sea-boss.vue::buildDeepSeaBossShare");
    expect(script).toContain("miniapp/pages/guides/maelstrom.vue::maelstromSections");
    expect(script).toContain("miniapp/pages/guides/maelstrom.vue::buildMaelstromShare");
    expect(script).toContain("miniapp/pages/guides/maelstrom-boss.vue::calculateMaelstromBoss");
    expect(script).toContain("miniapp/pages/guides/maelstrom-boss.vue::buildMaelstromBossShare");
    expect(script).toContain("miniapp/pages/guides/sky-tower.vue::skyTowerFloorPages");
    expect(script).toContain("miniapp/pages/guides/sky-tower.vue::getSkyTowerConfig");
    expect(script).toContain("miniapp/pages/guides/sky-tower.vue::buildSkyTowerShare");
    expect(script).toContain("miniapp/pages/guides/dungeon-materials.vue::buildDungeonMaterialsShare");
    expect(script).toContain("miniapp/pages/guides/dungeon-materials.vue::uni.previewImage");
    expect(script).toContain("miniapp/pages/guides/dungeon-materials.vue::活动材料");
    expect(script).toContain("miniapp/pages/guides/dungeon-guide.vue::buildDungeonGuideShare");
    expect(script).toContain("miniapp/pages/guides/dungeon-guide.vue::uni.previewImage");
    expect(script).toContain("miniapp/pages/guides/dungeon-guide.vue::dungeonGuideImageUrls");
    expect(script).toContain("miniapp/pages/guides/dungeon-guide.vue::v-for");
    expect(script).toContain("miniapp/pages/guides/dungeon-guide.vue::活动攻略");
    expect(script).toContain("miniapp/pages/guides/health-calculator.vue::calculateHealth");
    expect(script).toContain("miniapp/pages/guides/health-calculator.vue::buildHealthCalculatorShare");
    expect(script).toContain("miniapp/pages/guides/additional-calculator.vue::calculateAdditionalDamage");
    expect(script).toContain("miniapp/pages/guides/additional-calculator.vue::buildAdditionalCalculatorShare");
    expect(script).toContain("miniapp/pages/guides/card-upgrade.vue::calculateCardUpgrade");
    expect(script).toContain("miniapp/pages/guides/card-upgrade.vue::buildCardUpgradeShare");
    expect(script).toContain("miniapp/pages/guides/season-challenge.vue::calculateSeasonChallenge");
    expect(script).toContain("miniapp/pages/guides/season-challenge.vue::buildSeasonChallengeShare");
    expect(script).toContain("miniapp/api/client.ts::getSkyTowerConfig");
    expect(script).toContain("miniapp/api/client.ts::getAppConfig");
    expect(script).toContain("miniapp/api/client.ts::dungeonMaterialImageUrl");
    expect(script).toContain("miniapp/api/client.ts::dungeonGuideImageUrls");
    expect(script).toContain("admin/src/pages/SkyTowerSettingsPage.tsx::楼层|阵容说明|左侧战车|右侧战车|英雄位|战术备注");
    expect(script).toContain("admin/src/pages/SkyTowerSettingsPage.tsx::/admin/sky-tower/config");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::user_asset_publish_enabled");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::check_in_url");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::dungeon_material_image_url");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::dungeon_guide_image_url");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::活动材料");
    expect(script).toContain("admin/src/pages/ConfigPage.tsx::活动攻略");
  ...
  it("rejects archives that do not contain dragon ball price reference features", () => {
    ...
    expect(script).toContain("admin/src/pages/priceReferenceImport.ts");
    ...
    expect(script).toContain("admin/src/pages/PriceReferencePage.tsx::parsePriceReferenceImportText");
    expect(script).toContain("admin/src/pages/PriceReferencePage.tsx::批量解析");
    expect(script).toContain("admin/src/pages/PriceReferencePage.tsx::解析并填入最低价");
    expect(script).toContain("admin/src/pages/priceReferenceImport.ts::parseCompactProfessionQuality");
    expect(script).toContain("admin/src/pages/priceReferenceImport.ts::低价必须是正整数");
