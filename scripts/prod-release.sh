...
required_release_files=(
  ...
  "api/src/db/migrations/024_redeem_code_settings.sql"
  "api/src/db/migrations/025_sky_tower_settings.sql"
  "api/src/db/migrations/026_check_in_url_config.sql"
  "api/src/db/migrations/027_dungeon_image_urls.sql"
  "api/src/db/migrations/028_system_config_value_text.sql"
  ...
  "api/src/modules/redeemCodes/redeemCodes.routes.ts"
  "api/src/modules/redeemCodes/redeemCodeSettings.repository.ts"
  "api/src/modules/redeemCodes/redeemCodeSettings.mysql.repository.ts"
  "api/src/modules/skyTower/skyTower.routes.ts"
  "api/src/modules/skyTower/skyTowerSettings.repository.ts"
  "api/src/modules/skyTower/skyTowerSettings.mysql.repository.ts"
  ...
  "api/src/modules/admin/adminConfigs.routes.ts"
  ...
  "shared/src/redeemCodes.ts"
  "shared/src/maelstrom.ts"
  "shared/src/skyTower.ts"
  "shared/src/healthCalculator.ts"
  "shared/src/additionalCalculator.ts"
  "shared/src/cardUpgrade.ts"
  "shared/src/seasonChallenge.ts"
  ...
  "miniapp/pages/guides/index.vue"
  "miniapp/pages/guides/redeem-codes.vue"
  "miniapp/pages/guides/dragon-ball-system.vue"
  "miniapp/pages/guides/deep-sea-battle.vue"
  "miniapp/pages/guides/deep-sea-boss.vue"
  "miniapp/pages/guides/maelstrom.vue"
  "miniapp/pages/guides/maelstrom-boss.vue"
  "miniapp/pages/guides/sky-tower.vue"
  "miniapp/pages/guides/dungeon-materials.vue"
  "miniapp/pages/guides/dungeon-guide.vue"
  "miniapp/pages/guides/health-calculator.vue"
  "miniapp/pages/guides/additional-calculator.vue"
  "miniapp/pages/guides/card-upgrade.vue"
  "miniapp/pages/guides/season-challenge.vue"
  ...
  "admin/src/pages/RedeemCodeSettingsPage.tsx"
  "admin/src/pages/SkyTowerSettingsPage.tsx"
  "admin/src/pages/priceReferenceImport.ts"
...
required_release_markers=(
  ...
  "api/src/app.ts::registerRedeemCodeRoutes"
  "api/src/app.ts::registerSkyTowerRoutes"
  "api/src/modules/redeemCodes/redeemCodes.routes.ts::/api/redeem-codes"
  "api/src/modules/redeemCodes/redeemCodes.routes.ts::/admin/redeem-codes/config"
  "api/src/modules/redeemCodes/redeemCodeSettings.mysql.repository.ts::redeem_code_settings"
  "api/src/db/migrations/025_sky_tower_settings.sql::sky_tower_settings"
  "api/src/db/migrations/026_check_in_url_config.sql::check_in_url"
  "api/src/db/migrations/027_dungeon_image_urls.sql::dungeon_material_image_url"
  "api/src/db/migrations/027_dungeon_image_urls.sql::dungeon_guide_image_url"
  "api/src/db/migrations/028_system_config_value_text.sql::MODIFY config_value TEXT"
  "api/src/db/migrations/001_initial_schema.sql::sky_tower_settings"
  "api/src/db/migrations/001_initial_schema.sql::check_in_url"
  "api/src/db/migrations/001_initial_schema.sql::dungeon_material_image_url"
  "api/src/db/migrations/001_initial_schema.sql::dungeon_guide_image_url"
  "api/src/modules/admin/adminConfigs.routes.ts::/api/app-config"
  "api/src/modules/admin/adminConfigs.routes.ts::dungeonMaterialImageUrl"
  "api/src/modules/admin/adminConfigs.routes.ts::dungeonGuideImageUrls"
  "api/src/modules/skyTower/skyTower.routes.ts::/api/sky-tower"
  "api/src/modules/skyTower/skyTowerSettings.mysql.repository.ts::sky_tower_settings"
  "shared/src/redeemCodes.ts::parseRedeemCodeText"
  "shared/src/deepSeaBattle.ts::calculateDeepSeaBoss"
  "shared/src/maelstrom.ts::calculateMaelstromBoss"
  "shared/src/skyTower.ts::skyTowerFloorPages"
  "shared/src/skyTower.ts::parseSkyTowerConfigText"
  "shared/src/healthCalculator.ts::calculateHealth"
  "shared/src/additionalCalculator.ts::calculateAdditionalDamage"
  "shared/src/cardUpgrade.ts::calculateCardUpgrade"
  "shared/src/seasonChallenge.ts::calculateSeasonChallenge"
  "miniapp/utils/share.ts::buildGuidesShare"
  "miniapp/utils/share.ts::buildRedeemCodesShare"
  "miniapp/utils/share.ts::buildDragonBallSystemShare"
  "miniapp/utils/share.ts::buildDeepSeaBattleShare"
  "miniapp/utils/share.ts::buildDeepSeaBossShare"
  "miniapp/utils/share.ts::buildMaelstromShare"
  "miniapp/utils/share.ts::buildMaelstromBossShare"
  "miniapp/utils/share.ts::buildSkyTowerShare"
  "miniapp/utils/share.ts::buildHealthCalculatorShare"
  "miniapp/utils/share.ts::buildAdditionalCalculatorShare"
  "miniapp/utils/share.ts::buildCardUpgradeShare"
  "miniapp/utils/share.ts::buildSeasonChallengeShare"
  "miniapp/utils/share.ts::buildDungeonMaterialsShare"
  "miniapp/utils/share.ts::buildDungeonGuideShare"
  "admin/src/pages/RedeemCodeSettingsPage.tsx::兑换码|奖励说明|效期"
  "admin/src/pages/SkyTowerSettingsPage.tsx::楼层|阵容说明|左侧战车|右侧战车|英雄位|战术备注"
  "admin/src/pages/SkyTowerSettingsPage.tsx::/admin/sky-tower/config"
  "miniapp/pages/guides/index.vue::openRedeemCodes"
  "miniapp/pages/guides/index.vue::openDragonBallSystem"
  "miniapp/pages/guides/index.vue::openDeepSeaBattle"
  "miniapp/pages/guides/index.vue::openMaelstrom"
  "miniapp/pages/guides/index.vue::openSkyTower"
  "miniapp/pages/guides/index.vue::openDungeonMaterials"
  "miniapp/pages/guides/index.vue::openDungeonGuide"
  "miniapp/pages/guides/index.vue::hasActivityEntries"
  "miniapp/pages/guides/index.vue::dungeonMaterialImageUrl"
  "miniapp/pages/guides/index.vue::hasDungeonGuideImages"
  "miniapp/pages/guides/index.vue::dungeonGuideImageUrls"
  "miniapp/pages/guides/index.vue::openCardUpgrade"
  "miniapp/pages/guides/index.vue::openSeasonChallenge"
  "miniapp/pages/guides/index.vue::openHealthCalculator"
  "miniapp/pages/guides/index.vue::openAdditionalCalculator"
  "miniapp/pages/guides/index.vue::openCheckIn"
  "miniapp/pages/guides/index.vue::uni.setClipboardData"
  "miniapp/pages/guides/index.vue::请在微信内打开"
  "miniapp/pages/guides/index.vue::syncCustomTabBarSelected(1)"
  "miniapp/pages/guides/index.vue::buildGuidesShare"
  "miniapp/pages/guides/redeem-codes.vue::uni.setClipboardData"
  "miniapp/pages/guides/redeem-codes.vue::listRedeemCodes"
  "miniapp/pages/guides/redeem-codes.vue::buildRedeemCodesShare"
  "miniapp/pages/guides/dragon-ball-system.vue::龙珠获取方式"
  "miniapp/pages/guides/dragon-ball-system.vue::buildDragonBallSystemShare"
  "miniapp/pages/guides/deep-sea-battle.vue::deepSeaMapRows"
  "miniapp/pages/guides/deep-sea-battle.vue::buildDeepSeaBattleShare"
  "miniapp/pages/guides/deep-sea-boss.vue::calculateDeepSeaBoss"
  "miniapp/pages/guides/deep-sea-boss.vue::buildDeepSeaBossShare"
  "miniapp/pages/guides/maelstrom.vue::maelstromSections"
  "miniapp/pages/guides/maelstrom.vue::buildMaelstromShare"
  "miniapp/pages/guides/maelstrom-boss.vue::calculateMaelstromBoss"
  "miniapp/pages/guides/maelstrom-boss.vue::buildMaelstromBossShare"
  "miniapp/pages/guides/sky-tower.vue::skyTowerFloorPages"
  "miniapp/pages/guides/sky-tower.vue::getSkyTowerConfig"
  "miniapp/pages/guides/sky-tower.vue::buildSkyTowerShare"
  "miniapp/pages/guides/dungeon-materials.vue::buildDungeonMaterialsShare"
  "miniapp/pages/guides/dungeon-materials.vue::uni.previewImage"
  "miniapp/pages/guides/dungeon-materials.vue::活动材料"
  "miniapp/pages/guides/dungeon-guide.vue::buildDungeonGuideShare"
  "miniapp/pages/guides/dungeon-guide.vue::uni.previewImage"
  "miniapp/pages/guides/dungeon-guide.vue::dungeonGuideImageUrls"
  "miniapp/pages/guides/dungeon-guide.vue::v-for"
  "miniapp/pages/guides/dungeon-guide.vue::活动攻略"
  "miniapp/pages/guides/health-calculator.vue::calculateHealth"
  "miniapp/pages/guides/health-calculator.vue::buildHealthCalculatorShare"
  "miniapp/pages/guides/additional-calculator.vue::calculateAdditionalDamage"
  "miniapp/pages/guides/additional-calculator.vue::buildAdditionalCalculatorShare"
  "miniapp/pages/guides/card-upgrade.vue::calculateCardUpgrade"
  "miniapp/pages/guides/card-upgrade.vue::buildCardUpgradeShare"
  "miniapp/pages/guides/season-challenge.vue::calculateSeasonChallenge"
  "miniapp/pages/guides/season-challenge.vue::buildSeasonChallengeShare"
  "miniapp/api/client.ts::getSkyTowerConfig"
  "miniapp/api/client.ts::getAppConfig"
  "miniapp/api/client.ts::dungeonMaterialImageUrl"
  "miniapp/api/client.ts::dungeonGuideImageUrls"
  "admin/src/pages/ConfigPage.tsx::dungeon_material_image_url"
  "admin/src/pages/ConfigPage.tsx::dungeon_guide_image_url"
  ...
  "miniapp/pages/profile/index.vue::syncCustomTabBarSelected(2)"
  ...
  "admin/src/App.tsx::SkyTowerSettingsPage"
  ...
  "admin/src/components/AppLayout.tsx::天空塔设置"
  ...
  "admin/src/pages/PriceReferencePage.tsx::parsePriceReferenceImportText"
  "admin/src/pages/PriceReferencePage.tsx::批量解析"
  "admin/src/pages/PriceReferencePage.tsx::解析并填入最低价"
  "admin/src/pages/priceReferenceImport.ts::parseCompactProfessionQuality"
  "admin/src/pages/priceReferenceImport.ts::低价必须是正整数"
  ...
  "admin/src/pages/SkyTowerSettingsPage.tsx::天空塔设置"
  "admin/src/pages/SkyTowerSettingsPage.tsx::解析预览"
  "admin/src/pages/ConfigPage.tsx::user_asset_publish_enabled"
  "admin/src/pages/ConfigPage.tsx::free_exchange_publish_enabled"
  "admin/src/pages/ConfigPage.tsx::check_in_url"
  "admin/src/pages/ConfigPage.tsx::自由交换发布开关"
  "admin/src/pages/ConfigPage.tsx::活动材料"
  "admin/src/pages/ConfigPage.tsx::活动攻略"
