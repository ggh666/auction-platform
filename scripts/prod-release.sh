...
required_release_markers=(
  ...
  "api/src/config/env.ts::WECHAT_ASSET_MESSAGE_SUBSCRIBE_TEMPLATE_ID"
  ...
  "miniapp/utils/subscribeMessage.ts::UNI_APP_ASSET_MESSAGE_SUBSCRIBE_TEMPLATE_ID"
  "miniapp/vite.config.js::UNI_APP_ASSET_MESSAGE_SUBSCRIBE_TEMPLATE_ID"
  "miniapp/vite.config.js::__ASSET_MESSAGE_SUBSCRIBE_TEMPLATE_ID__"
  ...
  "miniapp/pages/exchange/detail.vue::登录后联系发布者"
